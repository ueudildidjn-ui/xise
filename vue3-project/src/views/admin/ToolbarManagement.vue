...
const formFields = [
  ...
  { key: 'icon', label: '图标名称', type: 'text', required: true, placeholder: '请输入图标名称（如：history）' },
  { key: 'url', label: '跳转链接', type: 'text', required: true, placeholder: '请输入跳转链接或路由（如：/browsing-history）' },
