...
const menuItems = [
  ...
  { path: '/admin/notification-templates', title: '通知模板', icon: 'post' },
  { path: '/admin/users', title: '用户管理', icon: 'user' },
  { path: '/admin/posts', title: '笔记管理', icon: 'post' },
  { path: '/admin/note-quality', title: '笔记质量', icon: 'verified' },
...
const currentPageDescription = computed(() => {
  const descriptions = {
    ...
    '/admin/notification-templates': '管理通知模板，自定义系统模板和邮件模板',
    '/admin/users': '管理用户账户和权限',
    '/admin/posts': '管理用户发布的笔记内容',
    '/admin/note-quality': '标记笔记质量等级并发放奖励',
